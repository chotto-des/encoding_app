...
<body>
	@include('partials.site_header', ['active' => 'edit-student', 'fullWidth' => true])
		...
		<section class="form-card">
			...
			<form class="form-grid" method="POST" action="{{ route('students.update', $student) }}">
				...
				<div class="form-group">
					...
					<input id="first_name" name="first_name" type="text" placeholder="Juan" autocomplete="given-name" class="form-input @error('first_name') input-error @enderror" value="{{ old('first_name', $student->first_name) }}">
				</div>

				<div class="form-group">
					<label for="middle_name" class="form-label">Middle Name</label>
					<input id="middle_name" name="middle_name" type="text" placeholder="Santos" autocomplete="additional-name" class="form-input" value="{{ old('middle_name', $student->middle_name) }}">
				</div>

				<div class="form-group col-full">
					<label for="last_name" class="form-label">Last Name <span class="required">*</span></label>
					<input id="last_name" name="last_name" type="text" placeholder="Dela Cruz" autocomplete="family-name" class="form-input @error('last_name') input-error @enderror" value="{{ old('last_name', $student->last_name) }}">
				</div>
				...
				<div class="form-group col-full">
					...
					<input id="elementary_school" name="elementary_school" type="text" placeholder="San Fernando Elementary School" autocomplete="off" class="form-input" value="{{ old('elementary_school', $student->elementary_school) }}">
				</div>
