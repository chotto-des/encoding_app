...
<body>
    ...
    <div class="card">
        ...
        <form action="{{ route('register.submit') }}" method="POST">
            ...
            <div class="form-group">
                <label for="middle_name">Middle Name <span style="font-weight:400; color:#9ca3af;">(Optional)</span></label>
                <input
                    type="text"
                    id="middle_name"
                    name="middle_name"
            ...
            <div class="form-group">
                <label for="extension_name">Extension Name <span style="font-weight:400; color:#9ca3af;">(e.g. Jr., Sr., III)</span></label>
                <input
                    type="text"
                    id="extension_name"
                    name="extension_name"
